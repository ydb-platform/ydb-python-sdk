...
_TABLESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='Ydb.Table.V1.TableService.ExecuteStreamQuery',
    index=19,
    containing_service=None,
    input_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__table__pb2._EXECUTESTREAMQUERYREQUEST,
    output_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__table__pb2._EXECUTESTREAMQUERYRESPONSE,
    options=None,
  ),
])
