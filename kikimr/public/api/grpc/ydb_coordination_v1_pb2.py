...
from ydb.public.api.protos import ydb_coordination_pb2 as kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2
...
_COORDINATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._SESSIONREQUEST,
    output_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._SESSIONRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    index=1,
    containing_service=None,
    input_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._CREATENODEREQUEST,
    output_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._CREATENODERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    index=2,
    containing_service=None,
    input_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._ALTERNODEREQUEST,
    output_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._ALTERNODERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    index=3,
    containing_service=None,
    input_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._DROPNODEREQUEST,
    output_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._DROPNODERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    index=4,
    containing_service=None,
    input_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._DESCRIBENODEREQUEST,
    output_type=kikimr_dot_public_dot_api_dot_protos_dot_ydb__coordination__pb2._DESCRIBENODERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
