...
class OperationServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CancelOperation = channel.unary_unary(
        ...
        request_serializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.CancelOperationRequest.SerializeToString,
        response_deserializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.CancelOperationResponse.FromString,
        )
    self.ForgetOperation = channel.unary_unary(
        '/Ydb.Operation.V1.OperationService/ForgetOperation',
        request_serializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.ForgetOperationRequest.SerializeToString,
        response_deserializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.ForgetOperationResponse.FromString,
        )
    self.ListOperations = channel.unary_unary(
        '/Ydb.Operation.V1.OperationService/ListOperations',
        request_serializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.ListOperationsRequest.SerializeToString,
        response_deserializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.ListOperationsResponse.FromString,
        )
...
def add_OperationServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'CancelOperation': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.CancelOperationRequest.FromString,
          response_serializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.CancelOperationResponse.SerializeToString,
      ),
      'ForgetOperation': grpc.unary_unary_rpc_method_handler(
          servicer.ForgetOperation,
          request_deserializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.ForgetOperationRequest.FromString,
          response_serializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.ForgetOperationResponse.SerializeToString,
      ),
      'ListOperations': grpc.unary_unary_rpc_method_handler(
          servicer.ListOperations,
          request_deserializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.ListOperationsRequest.FromString,
          response_serializer=kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2.ListOperationsResponse.SerializeToString,
      ),
  }
