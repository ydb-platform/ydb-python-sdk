...
class PersQueueService(object):
    ...
    @staticmethod
    def WriteSession(request_iterator,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/NPersQueue.PersQueueService/WriteSession',
    ...
    def ReadSession(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/NPersQueue.PersQueueService/ReadSession',
