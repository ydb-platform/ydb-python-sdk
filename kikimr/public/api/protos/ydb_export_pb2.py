...
_EXPORTTOS3SETTINGS_ITEM.fields_by_name['destination_prefix'].has_options = True
_EXPORTTOS3SETTINGS_ITEM.fields_by_name['destination_prefix']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\220\346*\001'))
