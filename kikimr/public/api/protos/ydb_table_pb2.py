...
_GLOBALINDEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='data_columns', full_name='Ydb.Table.GlobalIndex.data_columns', index=0,
...
_GLOBALASYNCINDEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='data_columns', full_name='Ydb.Table.GlobalAsyncIndex.data_columns', index=0,
      number=1, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXECUTESCANQUERYPARTIALRESULT.fields_by_name['query_stats'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__query__stats__pb2._QUERYSTATS
...
GlobalAsyncIndex = _reflection.GeneratedProtocolMessageType('GlobalAsyncIndex', (_message.Message,), dict(
