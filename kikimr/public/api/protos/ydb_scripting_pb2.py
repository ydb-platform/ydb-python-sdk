...
ExplainYqlResponse = _reflection.GeneratedProtocolMessageType('ExplainYqlResponse', (_message.Message,), dict(
...
ExplainYqlResult = _reflection.GeneratedProtocolMessageType('ExplainYqlResult', (_message.Message,), dict(
