...
_MAKEDIRECTORYRESPONSE.fields_by_name['operation'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2._OPERATION
_REMOVEDIRECTORYREQUEST.fields_by_name['operation_params'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_REMOVEDIRECTORYRESPONSE.fields_by_name['operation'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2._OPERATION
_LISTDIRECTORYREQUEST.fields_by_name['operation_params'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_LISTDIRECTORYRESPONSE.fields_by_name['operation'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2._OPERATION
...
_DESCRIBEPATHREQUEST.fields_by_name['operation_params'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_DESCRIBEPATHRESPONSE.fields_by_name['operation'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2._OPERATION
...
_MODIFYPERMISSIONSREQUEST.fields_by_name['operation_params'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_MODIFYPERMISSIONSREQUEST.fields_by_name['actions'].message_type = _PERMISSIONSACTION
_MODIFYPERMISSIONSRESPONSE.fields_by_name['operation'].message_type = kikimr_dot_public_dot_api_dot_protos_dot_ydb__operation__pb2._OPERATION
...
MakeDirectoryRequest = _reflection.GeneratedProtocolMessageType('MakeDirectoryRequest', (_message.Message,), dict(
  DESCRIPTOR = _MAKEDIRECTORYREQUEST,
  __module__ = 'kikimr.public.api.protos.ydb_scheme_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Scheme.MakeDirectoryRequest)
  ))
_sym_db.RegisterMessage(MakeDirectoryRequest)

MakeDirectoryResponse = _reflection.GeneratedProtocolMessageType('MakeDirectoryResponse', (_message.Message,), dict(
...
ListDirectoryRequest = _reflection.GeneratedProtocolMessageType('ListDirectoryRequest', (_message.Message,), dict(
...
ListDirectoryResponse = _reflection.GeneratedProtocolMessageType('ListDirectoryResponse', (_message.Message,), dict(
...
ListDirectoryResult = _reflection.GeneratedProtocolMessageType('ListDirectoryResult', (_message.Message,), dict(
...
DescribePathRequest = _reflection.GeneratedProtocolMessageType('DescribePathRequest', (_message.Message,), dict(
...
DescribePathResponse = _reflection.GeneratedProtocolMessageType('DescribePathResponse', (_message.Message,), dict(
...
DescribePathResult = _reflection.GeneratedProtocolMessageType('DescribePathResult', (_message.Message,), dict(
...
PermissionsAction = _reflection.GeneratedProtocolMessageType('PermissionsAction', (_message.Message,), dict(
...
ModifyPermissionsRequest = _reflection.GeneratedProtocolMessageType('ModifyPermissionsRequest', (_message.Message,), dict(
...
ModifyPermissionsResponse = _reflection.GeneratedProtocolMessageType('ModifyPermissionsResponse', (_message.Message,), dict(
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\024ru.yandex.ydb.schemeB\025SchemeOperationProtos\370\001\001'))
