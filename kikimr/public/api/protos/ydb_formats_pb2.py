...
ArrowBatchSettings = _reflection.GeneratedProtocolMessageType('ArrowBatchSettings', (_message.Message,), {
  ...
  '__module__' : 'kikimr.public.api.protos.ydb_formats_pb2'
