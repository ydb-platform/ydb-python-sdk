...
_TYPE_PRIMITIVETYPEID = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DATE32', index=19, number=64,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DATETIME64', index=20, number=65,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TIMESTAMP64', index=21, number=66,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='INTERVAL64', index=22, number=67,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='STRING', index=23, number=4097,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='UTF8', index=24, number=4608,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='YSON', index=25, number=4609,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='JSON', index=26, number=4610,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='JSON_DOCUMENT', index=28, number=4612,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DYNUMBER', index=29, number=4866,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_PGTYPE = _descriptor.Descriptor(
  name='PgType',
  full_name='Ydb.PgType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='type_name', full_name='Ydb.PgType.type_name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type_modifier', full_name='Ydb.PgType.type_modifier', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='oid', full_name='Ydb.PgType.oid', index=2,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='typlen', full_name='Ydb.PgType.typlen', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='typmod', full_name='Ydb.PgType.typmod', index=4,
...
_TYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pg_type', full_name='Ydb.Type.pg_type', index=13,
...
_TYPE.fields_by_name['pg_type'].message_type = _PGTYPE
...
_TYPE.oneofs_by_name['type'].fields.append(
  _TYPE.fields_by_name['pg_type'])
_TYPE.fields_by_name['pg_type'].containing_oneof = _TYPE.oneofs_by_name['type']
...
DESCRIPTOR.message_types_by_name['PgType'] = _PGTYPE
...
DecimalType = _reflection.GeneratedProtocolMessageType('DecimalType', (_message.Message,), {
  ...
  '__module__' : 'protos.ydb_value_pb2'
...
PgType = _reflection.GeneratedProtocolMessageType('PgType', (_message.Message,), {
  'DESCRIPTOR' : _PGTYPE,
  '__module__' : 'protos.ydb_value_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.PgType)
  })
_sym_db.RegisterMessage(PgType)
