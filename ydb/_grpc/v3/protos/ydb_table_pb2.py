...
from ydb._grpc.v3.protos import ydb_common_pb2 as protos_dot_ydb__common__pb2
...
_CHANGEFEEDMODE_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='Ydb.Table.ChangefeedMode.Mode',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MODE_KEYS_ONLY', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MODE_UPDATES', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MODE_NEW_IMAGE', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MODE_OLD_IMAGE', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='MODE_NEW_AND_OLD_IMAGES', index=5, number=5,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_CHANGEFEEDMODE_MODE)

_CHANGEFEEDFORMAT_FORMAT = _descriptor.EnumDescriptor(
  name='Format',
  full_name='Ydb.Table.ChangefeedFormat.Format',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='FORMAT_JSON', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='FORMAT_DYNAMODB_STREAMS_JSON', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='FORMAT_DEBEZIUM_JSON', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_CHANGEFEEDFORMAT_FORMAT)

_CHANGEFEEDDESCRIPTION_STATE = _descriptor.EnumDescriptor(
  name='State',
  full_name='Ydb.Table.ChangefeedDescription.State',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='STATE_INITIAL_SCAN', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_CHANGEFEEDDESCRIPTION_STATE)
...
_QUERYSTATSCOLLECTION_MODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='STATS_COLLECTION_PROFILE', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_GLOBALUNIQUEINDEX = _descriptor.Descriptor(
  name='GlobalUniqueIndex',
  full_name='Ydb.Table.GlobalUniqueIndex',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_TABLEINDEX = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='global_unique_index', full_name='Ydb.Table.TableIndex.global_unique_index', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data_columns', full_name='Ydb.Table.TableIndex.data_columns', index=5,
...
_TABLEINDEXDESCRIPTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='global_unique_index', full_name='Ydb.Table.TableIndexDescription.global_unique_index', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='Ydb.Table.TableIndexDescription.status', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data_columns', full_name='Ydb.Table.TableIndexDescription.data_columns', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='size_bytes', full_name='Ydb.Table.TableIndexDescription.size_bytes', index=7,
...
_CHANGEFEEDMODE = _descriptor.Descriptor(
  name='ChangefeedMode',
  full_name='Ydb.Table.ChangefeedMode',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_CHANGEFEEDFORMAT = _descriptor.Descriptor(
  name='ChangefeedFormat',
  full_name='Ydb.Table.ChangefeedFormat',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_CHANGEFEED_ATTRIBUTESENTRY = _descriptor.Descriptor(
  name='AttributesEntry',
  full_name='Ydb.Table.Changefeed.AttributesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='Ydb.Table.Changefeed.AttributesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='Ydb.Table.Changefeed.AttributesEntry.value', index=1,
...
_CHANGEFEED = _descriptor.Descriptor(
  name='Changefeed',
  full_name='Ydb.Table.Changefeed',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Ydb.Table.Changefeed.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mode', full_name='Ydb.Table.Changefeed.mode', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='format', full_name='Ydb.Table.Changefeed.format', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='retention_period', full_name='Ydb.Table.Changefeed.retention_period', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='virtual_timestamps', full_name='Ydb.Table.Changefeed.virtual_timestamps', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='initial_scan', full_name='Ydb.Table.Changefeed.initial_scan', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='Ydb.Table.Changefeed.attributes', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='aws_region', full_name='Ydb.Table.Changefeed.aws_region', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='resolved_timestamps_interval', full_name='Ydb.Table.Changefeed.resolved_timestamps_interval', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='topic_partitioning_settings', full_name='Ydb.Table.Changefeed.topic_partitioning_settings', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='schema_changes', full_name='Ydb.Table.Changefeed.schema_changes', index=10,
  ...
  nested_types=[_CHANGEFEED_ATTRIBUTESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CHANGEFEEDDESCRIPTION_INITIALSCANPROGRESS = _descriptor.Descriptor(
  name='InitialScanProgress',
  full_name='Ydb.Table.ChangefeedDescription.InitialScanProgress',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='parts_total', full_name='Ydb.Table.ChangefeedDescription.InitialScanProgress.parts_total', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='parts_completed', full_name='Ydb.Table.ChangefeedDescription.InitialScanProgress.parts_completed', index=1,
...
_CHANGEFEEDDESCRIPTION_ATTRIBUTESENTRY = _descriptor.Descriptor(
  name='AttributesEntry',
  full_name='Ydb.Table.ChangefeedDescription.AttributesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='Ydb.Table.ChangefeedDescription.AttributesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='Ydb.Table.ChangefeedDescription.AttributesEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CHANGEFEEDDESCRIPTION = _descriptor.Descriptor(
  name='ChangefeedDescription',
  full_name='Ydb.Table.ChangefeedDescription',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Ydb.Table.ChangefeedDescription.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mode', full_name='Ydb.Table.ChangefeedDescription.mode', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='format', full_name='Ydb.Table.ChangefeedDescription.format', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='state', full_name='Ydb.Table.ChangefeedDescription.state', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='virtual_timestamps', full_name='Ydb.Table.ChangefeedDescription.virtual_timestamps', index=4,
      number=5, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='Ydb.Table.ChangefeedDescription.attributes', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='aws_region', full_name='Ydb.Table.ChangefeedDescription.aws_region', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resolved_timestamps_interval', full_name='Ydb.Table.ChangefeedDescription.resolved_timestamps_interval', index=7,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='initial_scan_progress', full_name='Ydb.Table.ChangefeedDescription.initial_scan_progress', index=8,
      number=9, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='schema_changes', full_name='Ydb.Table.ChangefeedDescription.schema_changes', index=9,
  ...
  nested_types=[_CHANGEFEEDDESCRIPTION_INITIALSCANPROGRESS, _CHANGEFEEDDESCRIPTION_ATTRIBUTESENTRY, ],
  enum_types=[
    _CHANGEFEEDDESCRIPTION_STATE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_PARTITIONSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='leader_node_id', full_name='Ydb.Table.PartitionStats.leader_node_id', index=2,
...
_SEQUENCEDESCRIPTION_SETVAL = _descriptor.Descriptor(
  name='SetVal',
  full_name='Ydb.Table.SequenceDescription.SetVal',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='next_value', full_name='Ydb.Table.SequenceDescription.SetVal.next_value', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='next_used', full_name='Ydb.Table.SequenceDescription.SetVal.next_used', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_next_value', full_name='Ydb.Table.SequenceDescription.SetVal._next_value',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_next_used', full_name='Ydb.Table.SequenceDescription.SetVal._next_used',
...
_SEQUENCEDESCRIPTION = _descriptor.Descriptor(
  name='SequenceDescription',
  full_name='Ydb.Table.SequenceDescription',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Ydb.Table.SequenceDescription.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='min_value', full_name='Ydb.Table.SequenceDescription.min_value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_value', full_name='Ydb.Table.SequenceDescription.max_value', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_value', full_name='Ydb.Table.SequenceDescription.start_value', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cache', full_name='Ydb.Table.SequenceDescription.cache', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='increment', full_name='Ydb.Table.SequenceDescription.increment', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cycle', full_name='Ydb.Table.SequenceDescription.cycle', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='set_val', full_name='Ydb.Table.SequenceDescription.set_val', index=7,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_SEQUENCEDESCRIPTION_SETVAL, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_name', full_name='Ydb.Table.SequenceDescription._name',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_min_value', full_name='Ydb.Table.SequenceDescription._min_value',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_start_value', full_name='Ydb.Table.SequenceDescription._start_value',
      index=3, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_cache', full_name='Ydb.Table.SequenceDescription._cache',
      index=4, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_increment', full_name='Ydb.Table.SequenceDescription._increment',
      index=5, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_cycle', full_name='Ydb.Table.SequenceDescription._cycle',
      index=6, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_set_val', full_name='Ydb.Table.SequenceDescription._set_val',
...
_COLUMNMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='not_null', full_name='Ydb.Table.ColumnMeta.not_null', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='from_literal', full_name='Ydb.Table.ColumnMeta.from_literal', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='from_sequence', full_name='Ydb.Table.ColumnMeta.from_sequence', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='default_value', full_name='Ydb.Table.ColumnMeta.default_value',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_not_null', full_name='Ydb.Table.ColumnMeta._not_null',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_PARTITIONINGSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='partition_by', full_name='Ydb.Table.PartitioningSettings.partition_by', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partitioning_by_size', full_name='Ydb.Table.PartitioningSettings.partitioning_by_size', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partition_size_mb', full_name='Ydb.Table.PartitioningSettings.partition_size_mb', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='partitioning_by_load', full_name='Ydb.Table.PartitioningSettings.partitioning_by_load', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='min_partitions_count', full_name='Ydb.Table.PartitioningSettings.min_partitions_count', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_partitions_count', full_name='Ydb.Table.PartitioningSettings.max_partitions_count', index=5,
      number=7, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATETABLEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tiering', full_name='Ydb.Table.CreateTableRequest.tiering', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='temporary', full_name='Ydb.Table.CreateTableRequest.temporary', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='store_type', full_name='Ydb.Table.CreateTableRequest.store_type', index=19,
...
_RENAMEINDEXITEM = _descriptor.Descriptor(
  name='RenameIndexItem',
  full_name='Ydb.Table.RenameIndexItem',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='source_name', full_name='Ydb.Table.RenameIndexItem.source_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='destination_name', full_name='Ydb.Table.RenameIndexItem.destination_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='replace_destination', full_name='Ydb.Table.RenameIndexItem.replace_destination', index=2,
...
_ALTERTABLEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='add_changefeeds', full_name='Ydb.Table.AlterTableRequest.add_changefeeds', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='drop_changefeeds', full_name='Ydb.Table.AlterTableRequest.drop_changefeeds', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rename_indexes', full_name='Ydb.Table.AlterTableRequest.rename_indexes', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='set_tiering', full_name='Ydb.Table.AlterTableRequest.set_tiering', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='drop_tiering', full_name='Ydb.Table.AlterTableRequest.drop_tiering', index=22,
  ...
  oneofs=[
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='tiering_action', full_name='Ydb.Table.AlterTableRequest.tiering_action',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_DESCRIBETABLEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='include_set_val', full_name='Ydb.Table.DescribeTableRequest.include_set_val', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='include_shard_nodes_info', full_name='Ydb.Table.DescribeTableRequest.include_shard_nodes_info', index=7,
...
_DESCRIBETABLERESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='changefeeds', full_name='Ydb.Table.DescribeTableResult.changefeeds', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tiering', full_name='Ydb.Table.DescribeTableResult.tiering', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='temporary', full_name='Ydb.Table.DescribeTableResult.temporary', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='store_type', full_name='Ydb.Table.DescribeTableResult.store_type', index=16,
...
_SNAPSHOTMODESETTINGS = _descriptor.Descriptor(
  ...
  full_name='Ydb.Table.SnapshotModeSettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_SNAPSHOTRWMODESETTINGS = _descriptor.Descriptor(
  name='SnapshotRWModeSettings',
  full_name='Ydb.Table.SnapshotRWModeSettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_READCOMMITTEDRWMODESETTINGS = _descriptor.Descriptor(
  name='ReadCommittedRWModeSettings',
  full_name='Ydb.Table.ReadCommittedRWModeSettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_STRICTSERIALIZABLERWMODESETTINGS = _descriptor.Descriptor(
  name='StrictSerializableRWModeSettings',
  full_name='Ydb.Table.StrictSerializableRWModeSettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_TRANSACTIONSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='snapshot_read_only', full_name='Ydb.Table.TransactionSettings.snapshot_read_only', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='snapshot_read_write', full_name='Ydb.Table.TransactionSettings.snapshot_read_write', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_committed_read_write', full_name='Ydb.Table.TransactionSettings.read_committed_read_write', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='strict_serializable_read_write', full_name='Ydb.Table.TransactionSettings.strict_serializable_read_write', index=6,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXPLAINDATAQUERYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='collect_full_diagnostics', full_name='Ydb.Table.ExplainDataQueryRequest.collect_full_diagnostics', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXPLAINQUERYRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='query_full_diagnostics', full_name='Ydb.Table.ExplainQueryResult.query_full_diagnostics', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_READTABLEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='batch_limit_bytes', full_name='Ydb.Table.ReadTableRequest.batch_limit_bytes', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='batch_limit_rows', full_name='Ydb.Table.ReadTableRequest.batch_limit_rows', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='return_not_null_data_as_optional', full_name='Ydb.Table.ReadTableRequest.return_not_null_data_as_optional', index=9,
...
_READTABLERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='snapshot', full_name='Ydb.Table.ReadTableResponse.snapshot', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='result', full_name='Ydb.Table.ReadTableResponse.result', index=3,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_READROWSREQUEST = _descriptor.Descriptor(
  ...
  full_name='Ydb.Table.ReadRowsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='session_id', full_name='Ydb.Table.ReadRowsRequest.session_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='path', full_name='Ydb.Table.ReadRowsRequest.path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='keys', full_name='Ydb.Table.ReadRowsRequest.keys', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='columns', full_name='Ydb.Table.ReadRowsRequest.columns', index=3,
      number=4, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_READROWSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='Ydb.Table.ReadRowsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='Ydb.Table.ReadRowsResponse.status', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='issues', full_name='Ydb.Table.ReadRowsResponse.issues', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='result_set', full_name='Ydb.Table.ReadRowsResponse.result_set', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXECUTESCANQUERYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='collect_full_diagnostics', full_name='Ydb.Table.ExecuteScanQueryRequest.collect_full_diagnostics', index=4,
      number=9, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXECUTESCANQUERYPARTIALRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='query_full_diagnostics', full_name='Ydb.Table.ExecuteScanQueryPartialResult.query_full_diagnostics', index=2,
      number=7, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\030\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='snapshot', full_name='Ydb.Table.ExecuteScanQueryPartialResult.snapshot', index=3,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBEEXTERNALDATASOURCEREQUEST = _descriptor.Descriptor(
  name='DescribeExternalDataSourceRequest',
  full_name='Ydb.Table.DescribeExternalDataSourceRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='operation_params', full_name='Ydb.Table.DescribeExternalDataSourceRequest.operation_params', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='path', full_name='Ydb.Table.DescribeExternalDataSourceRequest.path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBEEXTERNALDATASOURCERESPONSE = _descriptor.Descriptor(
  name='DescribeExternalDataSourceResponse',
  full_name='Ydb.Table.DescribeExternalDataSourceResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='operation', full_name='Ydb.Table.DescribeExternalDataSourceResponse.operation', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBEEXTERNALDATASOURCERESULT_PROPERTIESENTRY = _descriptor.Descriptor(
  name='PropertiesEntry',
  full_name='Ydb.Table.DescribeExternalDataSourceResult.PropertiesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='Ydb.Table.DescribeExternalDataSourceResult.PropertiesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='Ydb.Table.DescribeExternalDataSourceResult.PropertiesEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBEEXTERNALDATASOURCERESULT = _descriptor.Descriptor(
  name='DescribeExternalDataSourceResult',
  full_name='Ydb.Table.DescribeExternalDataSourceResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='self', full_name='Ydb.Table.DescribeExternalDataSourceResult.self', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='source_type', full_name='Ydb.Table.DescribeExternalDataSourceResult.source_type', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='location', full_name='Ydb.Table.DescribeExternalDataSourceResult.location', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='properties', full_name='Ydb.Table.DescribeExternalDataSourceResult.properties', index=3,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_DESCRIBEEXTERNALDATASOURCERESULT_PROPERTIESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_source_type', full_name='Ydb.Table.DescribeExternalDataSourceResult._source_type',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_location', full_name='Ydb.Table.DescribeExternalDataSourceResult._location',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_DESCRIBEEXTERNALTABLEREQUEST = _descriptor.Descriptor(
  name='DescribeExternalTableRequest',
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='operation_params', full_name='Ydb.Table.DescribeExternalTableRequest.operation_params', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='path', full_name='Ydb.Table.DescribeExternalTableRequest.path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBEEXTERNALTABLERESPONSE = _descriptor.Descriptor(
  name='DescribeExternalTableResponse',
  full_name='Ydb.Table.DescribeExternalTableResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='operation', full_name='Ydb.Table.DescribeExternalTableResponse.operation', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBEEXTERNALTABLERESULT_CONTENTENTRY = _descriptor.Descriptor(
  name='ContentEntry',
  full_name='Ydb.Table.DescribeExternalTableResult.ContentEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='Ydb.Table.DescribeExternalTableResult.ContentEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='Ydb.Table.DescribeExternalTableResult.ContentEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBEEXTERNALTABLERESULT = _descriptor.Descriptor(
  name='DescribeExternalTableResult',
  full_name='Ydb.Table.DescribeExternalTableResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='self', full_name='Ydb.Table.DescribeExternalTableResult.self', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='source_type', full_name='Ydb.Table.DescribeExternalTableResult.source_type', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data_source_path', full_name='Ydb.Table.DescribeExternalTableResult.data_source_path', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='location', full_name='Ydb.Table.DescribeExternalTableResult.location', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='columns', full_name='Ydb.Table.DescribeExternalTableResult.columns', index=4,
      number=5, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='content', full_name='Ydb.Table.DescribeExternalTableResult.content', index=5,
      number=6, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_DESCRIBEEXTERNALTABLERESULT_CONTENTENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_data_source_path', full_name='Ydb.Table.DescribeExternalTableResult._data_source_path',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_location', full_name='Ydb.Table.DescribeExternalTableResult._location',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_DESCRIBESYSTEMVIEWREQUEST = _descriptor.Descriptor(
  name='DescribeSystemViewRequest',
  full_name='Ydb.Table.DescribeSystemViewRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='operation_params', full_name='Ydb.Table.DescribeSystemViewRequest.operation_params', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='path', full_name='Ydb.Table.DescribeSystemViewRequest.path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBESYSTEMVIEWRESPONSE = _descriptor.Descriptor(
  name='DescribeSystemViewResponse',
  full_name='Ydb.Table.DescribeSystemViewResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='operation', full_name='Ydb.Table.DescribeSystemViewResponse.operation', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBESYSTEMVIEWRESULT_ATTRIBUTESENTRY = _descriptor.Descriptor(
  name='AttributesEntry',
  full_name='Ydb.Table.DescribeSystemViewResult.AttributesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='Ydb.Table.DescribeSystemViewResult.AttributesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='Ydb.Table.DescribeSystemViewResult.AttributesEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESCRIBESYSTEMVIEWRESULT = _descriptor.Descriptor(
  name='DescribeSystemViewResult',
  full_name='Ydb.Table.DescribeSystemViewResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='self', full_name='Ydb.Table.DescribeSystemViewResult.self', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sys_view_id', full_name='Ydb.Table.DescribeSystemViewResult.sys_view_id', index=1,
      number=2, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sys_view_name', full_name='Ydb.Table.DescribeSystemViewResult.sys_view_name', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='columns', full_name='Ydb.Table.DescribeSystemViewResult.columns', index=3,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='primary_key', full_name='Ydb.Table.DescribeSystemViewResult.primary_key', index=4,
      number=5, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attributes', full_name='Ydb.Table.DescribeSystemViewResult.attributes', index=5,
      number=6, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_DESCRIBESYSTEMVIEWRESULT_ATTRIBUTESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CREATESESSIONREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_CREATESESSIONRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_DELETESESSIONREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_DELETESESSIONRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
...
_TABLEINDEX.fields_by_name['global_unique_index'].message_type = _GLOBALUNIQUEINDEX
...
_TABLEINDEX.oneofs_by_name['type'].fields.append(
  _TABLEINDEX.fields_by_name['global_unique_index'])
_TABLEINDEX.fields_by_name['global_unique_index'].containing_oneof = _TABLEINDEX.oneofs_by_name['type']
...
_TABLEINDEXDESCRIPTION.fields_by_name['global_unique_index'].message_type = _GLOBALUNIQUEINDEX
...
_TABLEINDEXDESCRIPTION.oneofs_by_name['type'].fields.append(
  _TABLEINDEXDESCRIPTION.fields_by_name['global_unique_index'])
_TABLEINDEXDESCRIPTION.fields_by_name['global_unique_index'].containing_oneof = _TABLEINDEXDESCRIPTION.oneofs_by_name['type']
...
_CHANGEFEEDMODE_MODE.containing_type = _CHANGEFEEDMODE
_CHANGEFEEDFORMAT_FORMAT.containing_type = _CHANGEFEEDFORMAT
_CHANGEFEED_ATTRIBUTESENTRY.containing_type = _CHANGEFEED
_CHANGEFEED.fields_by_name['mode'].enum_type = _CHANGEFEEDMODE_MODE
_CHANGEFEED.fields_by_name['format'].enum_type = _CHANGEFEEDFORMAT_FORMAT
_CHANGEFEED.fields_by_name['retention_period'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
_CHANGEFEED.fields_by_name['attributes'].message_type = _CHANGEFEED_ATTRIBUTESENTRY
_CHANGEFEED.fields_by_name['resolved_timestamps_interval'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
_CHANGEFEED.fields_by_name['topic_partitioning_settings'].message_type = protos_dot_ydb__topic__pb2._PARTITIONINGSETTINGS
_CHANGEFEEDDESCRIPTION_INITIALSCANPROGRESS.containing_type = _CHANGEFEEDDESCRIPTION
_CHANGEFEEDDESCRIPTION_ATTRIBUTESENTRY.containing_type = _CHANGEFEEDDESCRIPTION
_CHANGEFEEDDESCRIPTION.fields_by_name['mode'].enum_type = _CHANGEFEEDMODE_MODE
_CHANGEFEEDDESCRIPTION.fields_by_name['format'].enum_type = _CHANGEFEEDFORMAT_FORMAT
_CHANGEFEEDDESCRIPTION.fields_by_name['state'].enum_type = _CHANGEFEEDDESCRIPTION_STATE
_CHANGEFEEDDESCRIPTION.fields_by_name['attributes'].message_type = _CHANGEFEEDDESCRIPTION_ATTRIBUTESENTRY
...
_CHANGEFEEDDESCRIPTION.fields_by_name['initial_scan_progress'].message_type = _CHANGEFEEDDESCRIPTION_INITIALSCANPROGRESS
_CHANGEFEEDDESCRIPTION_STATE.containing_type = _CHANGEFEEDDESCRIPTION
...
_STORAGEPOLICY.fields_by_name['keep_in_memory'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
...
_COLUMNFAMILYPOLICY.fields_by_name['keep_in_memory'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
...
_EXPLICITPARTITIONS.fields_by_name['split_points'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
...
_REPLICATIONPOLICY.fields_by_name['create_per_availability_zone'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
_REPLICATIONPOLICY.fields_by_name['allow_promotion'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
...
_SEQUENCEDESCRIPTION_SETVAL.containing_type = _SEQUENCEDESCRIPTION
_SEQUENCEDESCRIPTION_SETVAL.oneofs_by_name['_next_value'].fields.append(
  _SEQUENCEDESCRIPTION_SETVAL.fields_by_name['next_value'])
_SEQUENCEDESCRIPTION_SETVAL.fields_by_name['next_value'].containing_oneof = _SEQUENCEDESCRIPTION_SETVAL.oneofs_by_name['_next_value']
_SEQUENCEDESCRIPTION_SETVAL.oneofs_by_name['_next_used'].fields.append(
  _SEQUENCEDESCRIPTION_SETVAL.fields_by_name['next_used'])
_SEQUENCEDESCRIPTION_SETVAL.fields_by_name['next_used'].containing_oneof = _SEQUENCEDESCRIPTION_SETVAL.oneofs_by_name['_next_used']
_SEQUENCEDESCRIPTION.fields_by_name['set_val'].message_type = _SEQUENCEDESCRIPTION_SETVAL
_SEQUENCEDESCRIPTION.oneofs_by_name['_name'].fields.append(
  _SEQUENCEDESCRIPTION.fields_by_name['name'])
_SEQUENCEDESCRIPTION.fields_by_name['name'].containing_oneof = _SEQUENCEDESCRIPTION.oneofs_by_name['_name']
_SEQUENCEDESCRIPTION.oneofs_by_name['_min_value'].fields.append(
  _SEQUENCEDESCRIPTION.fields_by_name['min_value'])
_SEQUENCEDESCRIPTION.fields_by_name['min_value'].containing_oneof = _SEQUENCEDESCRIPTION.oneofs_by_name['_min_value']
_SEQUENCEDESCRIPTION.oneofs_by_name['_max_value'].fields.append(
  _SEQUENCEDESCRIPTION.fields_by_name['max_value'])
_SEQUENCEDESCRIPTION.fields_by_name['max_value'].containing_oneof = _SEQUENCEDESCRIPTION.oneofs_by_name['_max_value']
_SEQUENCEDESCRIPTION.oneofs_by_name['_start_value'].fields.append(
  _SEQUENCEDESCRIPTION.fields_by_name['start_value'])
_SEQUENCEDESCRIPTION.fields_by_name['start_value'].containing_oneof = _SEQUENCEDESCRIPTION.oneofs_by_name['_start_value']
_SEQUENCEDESCRIPTION.oneofs_by_name['_cache'].fields.append(
  _SEQUENCEDESCRIPTION.fields_by_name['cache'])
_SEQUENCEDESCRIPTION.fields_by_name['cache'].containing_oneof = _SEQUENCEDESCRIPTION.oneofs_by_name['_cache']
_SEQUENCEDESCRIPTION.oneofs_by_name['_increment'].fields.append(
  _SEQUENCEDESCRIPTION.fields_by_name['increment'])
_SEQUENCEDESCRIPTION.fields_by_name['increment'].containing_oneof = _SEQUENCEDESCRIPTION.oneofs_by_name['_increment']
_SEQUENCEDESCRIPTION.oneofs_by_name['_cycle'].fields.append(
  _SEQUENCEDESCRIPTION.fields_by_name['cycle'])
_SEQUENCEDESCRIPTION.fields_by_name['cycle'].containing_oneof = _SEQUENCEDESCRIPTION.oneofs_by_name['_cycle']
_SEQUENCEDESCRIPTION.oneofs_by_name['_set_val'].fields.append(
  _SEQUENCEDESCRIPTION.fields_by_name['set_val'])
_SEQUENCEDESCRIPTION.fields_by_name['set_val'].containing_oneof = _SEQUENCEDESCRIPTION.oneofs_by_name['_set_val']
_COLUMNMETA.fields_by_name['type'].message_type = protos_dot_ydb__value__pb2._TYPE
_COLUMNMETA.fields_by_name['from_literal'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
_COLUMNMETA.fields_by_name['from_sequence'].message_type = _SEQUENCEDESCRIPTION
_COLUMNMETA.oneofs_by_name['default_value'].fields.append(
  _COLUMNMETA.fields_by_name['from_literal'])
_COLUMNMETA.fields_by_name['from_literal'].containing_oneof = _COLUMNMETA.oneofs_by_name['default_value']
_COLUMNMETA.oneofs_by_name['default_value'].fields.append(
  _COLUMNMETA.fields_by_name['from_sequence'])
_COLUMNMETA.fields_by_name['from_sequence'].containing_oneof = _COLUMNMETA.oneofs_by_name['default_value']
_COLUMNMETA.oneofs_by_name['_not_null'].fields.append(
  _COLUMNMETA.fields_by_name['not_null'])
_COLUMNMETA.fields_by_name['not_null'].containing_oneof = _COLUMNMETA.oneofs_by_name['_not_null']
...
_STORAGESETTINGS.fields_by_name['store_external_blobs'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
...
_COLUMNFAMILY.fields_by_name['keep_in_memory'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
_COLUMNFAMILY_COMPRESSION.containing_type = _COLUMNFAMILY
_PARTITIONINGSETTINGS.fields_by_name['partitioning_by_size'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
_PARTITIONINGSETTINGS.fields_by_name['partitioning_by_load'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
...
_CREATETABLEREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
...
_CREATETABLEREQUEST.fields_by_name['key_bloom_filter'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
_CREATETABLEREQUEST.fields_by_name['read_replicas_settings'].message_type = _READREPLICASSETTINGS
_CREATETABLEREQUEST.fields_by_name['store_type'].enum_type = _STORETYPE
...
_CREATETABLERESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_DROPTABLEREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_DROPTABLERESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
...
_ALTERTABLEREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
...
_ALTERTABLEREQUEST.fields_by_name['set_key_bloom_filter'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
_ALTERTABLEREQUEST.fields_by_name['set_read_replicas_settings'].message_type = _READREPLICASSETTINGS
_ALTERTABLEREQUEST.fields_by_name['add_changefeeds'].message_type = _CHANGEFEED
_ALTERTABLEREQUEST.fields_by_name['rename_indexes'].message_type = _RENAMEINDEXITEM
_ALTERTABLEREQUEST.fields_by_name['drop_tiering'].message_type = google_dot_protobuf_dot_empty__pb2._EMPTY
...
_ALTERTABLEREQUEST.oneofs_by_name['tiering_action'].fields.append(
  _ALTERTABLEREQUEST.fields_by_name['set_tiering'])
_ALTERTABLEREQUEST.fields_by_name['set_tiering'].containing_oneof = _ALTERTABLEREQUEST.oneofs_by_name['tiering_action']
_ALTERTABLEREQUEST.oneofs_by_name['tiering_action'].fields.append(
  _ALTERTABLEREQUEST.fields_by_name['drop_tiering'])
_ALTERTABLEREQUEST.fields_by_name['drop_tiering'].containing_oneof = _ALTERTABLEREQUEST.oneofs_by_name['tiering_action']
_ALTERTABLERESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_COPYTABLEREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_COPYTABLERESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_COPYTABLESREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_COPYTABLESREQUEST.fields_by_name['tables'].message_type = _COPYTABLEITEM
_COPYTABLESRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_RENAMETABLESREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_RENAMETABLESREQUEST.fields_by_name['tables'].message_type = _RENAMETABLEITEM
_RENAMETABLESRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_DESCRIBETABLEREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_DESCRIBETABLERESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_DESCRIBETABLERESULT_ATTRIBUTESENTRY.containing_type = _DESCRIBETABLERESULT
_DESCRIBETABLERESULT.fields_by_name['self'].message_type = protos_dot_ydb__scheme__pb2._ENTRY
_DESCRIBETABLERESULT.fields_by_name['columns'].message_type = _COLUMNMETA
_DESCRIBETABLERESULT.fields_by_name['shard_key_bounds'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
...
_DESCRIBETABLERESULT.fields_by_name['key_bloom_filter'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
_DESCRIBETABLERESULT.fields_by_name['read_replicas_settings'].message_type = _READREPLICASSETTINGS
_DESCRIBETABLERESULT.fields_by_name['changefeeds'].message_type = _CHANGEFEEDDESCRIPTION
_DESCRIBETABLERESULT.fields_by_name['store_type'].enum_type = _STORETYPE
...
_TRANSACTIONSETTINGS.fields_by_name['snapshot_read_write'].message_type = _SNAPSHOTRWMODESETTINGS
_TRANSACTIONSETTINGS.fields_by_name['read_committed_read_write'].message_type = _READCOMMITTEDRWMODESETTINGS
_TRANSACTIONSETTINGS.fields_by_name['strict_serializable_read_write'].message_type = _STRICTSERIALIZABLERWMODESETTINGS
...
_TRANSACTIONSETTINGS.oneofs_by_name['tx_mode'].fields.append(
  _TRANSACTIONSETTINGS.fields_by_name['snapshot_read_write'])
_TRANSACTIONSETTINGS.fields_by_name['snapshot_read_write'].containing_oneof = _TRANSACTIONSETTINGS.oneofs_by_name['tx_mode']
_TRANSACTIONSETTINGS.oneofs_by_name['tx_mode'].fields.append(
  _TRANSACTIONSETTINGS.fields_by_name['read_committed_read_write'])
_TRANSACTIONSETTINGS.fields_by_name['read_committed_read_write'].containing_oneof = _TRANSACTIONSETTINGS.oneofs_by_name['tx_mode']
_TRANSACTIONSETTINGS.oneofs_by_name['tx_mode'].fields.append(
  _TRANSACTIONSETTINGS.fields_by_name['strict_serializable_read_write'])
_TRANSACTIONSETTINGS.fields_by_name['strict_serializable_read_write'].containing_oneof = _TRANSACTIONSETTINGS.oneofs_by_name['tx_mode']
...
_EXECUTEDATAQUERYREQUEST_PARAMETERSENTRY.fields_by_name['value'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
...
_EXECUTEDATAQUERYREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_EXECUTEDATAQUERYREQUEST.fields_by_name['collect_stats'].enum_type = _QUERYSTATSCOLLECTION_MODE
_EXECUTEDATAQUERYRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_EXECUTESCHEMEQUERYREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_EXECUTESCHEMEQUERYRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_QUERYMETA_PARAMETERSTYPESENTRY.fields_by_name['value'].message_type = protos_dot_ydb__value__pb2._TYPE
...
_EXECUTEQUERYRESULT.fields_by_name['result_sets'].message_type = protos_dot_ydb__value__pb2._RESULTSET
...
_EXECUTEQUERYRESULT.fields_by_name['query_stats'].message_type = protos_dot_ydb__query__stats__pb2._QUERYSTATS
_EXPLAINDATAQUERYREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_EXPLAINDATAQUERYRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_PREPAREDATAQUERYREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_PREPAREDATAQUERYRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_PREPAREQUERYRESULT_PARAMETERSTYPESENTRY.fields_by_name['value'].message_type = protos_dot_ydb__value__pb2._TYPE
...
_KEEPALIVEREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_KEEPALIVERESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
...
_BEGINTRANSACTIONREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_BEGINTRANSACTIONRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_BEGINTRANSACTIONRESULT.fields_by_name['tx_meta'].message_type = _TRANSACTIONMETA
_COMMITTRANSACTIONREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_COMMITTRANSACTIONREQUEST.fields_by_name['collect_stats'].enum_type = _QUERYSTATSCOLLECTION_MODE
_COMMITTRANSACTIONRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_COMMITTRANSACTIONRESULT.fields_by_name['query_stats'].message_type = protos_dot_ydb__query__stats__pb2._QUERYSTATS
_ROLLBACKTRANSACTIONREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_ROLLBACKTRANSACTIONRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
...
_DESCRIBETABLEOPTIONSREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_DESCRIBETABLEOPTIONSRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
...
_KEYRANGE.fields_by_name['greater'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
_KEYRANGE.fields_by_name['greater_or_equal'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
_KEYRANGE.fields_by_name['less'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
_KEYRANGE.fields_by_name['less_or_equal'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
...
_READTABLEREQUEST.fields_by_name['use_snapshot'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
_READTABLEREQUEST.fields_by_name['return_not_null_data_as_optional'].enum_type = protos_dot_ydb__common__pb2._FEATUREFLAG_STATUS
_READTABLERESPONSE.fields_by_name['status'].enum_type = protos_dot_ydb__status__codes__pb2._STATUSIDS_STATUSCODE
_READTABLERESPONSE.fields_by_name['issues'].message_type = protos_dot_ydb__issue__message__pb2._ISSUEMESSAGE
_READTABLERESPONSE.fields_by_name['snapshot'].message_type = protos_dot_ydb__common__pb2._VIRTUALTIMESTAMP
_READTABLERESPONSE.fields_by_name['result'].message_type = _READTABLERESULT
_READTABLERESULT.fields_by_name['result_set'].message_type = protos_dot_ydb__value__pb2._RESULTSET
_READROWSREQUEST.fields_by_name['keys'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
_READROWSRESPONSE.fields_by_name['status'].enum_type = protos_dot_ydb__status__codes__pb2._STATUSIDS_STATUSCODE
_READROWSRESPONSE.fields_by_name['issues'].message_type = protos_dot_ydb__issue__message__pb2._ISSUEMESSAGE
_READROWSRESPONSE.fields_by_name['result_set'].message_type = protos_dot_ydb__value__pb2._RESULTSET
_BULKUPSERTREQUEST.fields_by_name['rows'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
_BULKUPSERTREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_BULKUPSERTREQUEST.fields_by_name['arrow_batch_settings'].message_type = protos_dot_ydb__formats__pb2._ARROWBATCHSETTINGS
_BULKUPSERTREQUEST.fields_by_name['csv_settings'].message_type = protos_dot_ydb__formats__pb2._CSVSETTINGS
...
_BULKUPSERTRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_EXECUTESCANQUERYREQUEST_PARAMETERSENTRY.fields_by_name['value'].message_type = protos_dot_ydb__value__pb2._TYPEDVALUE
...
_EXECUTESCANQUERYPARTIALRESPONSE.fields_by_name['status'].enum_type = protos_dot_ydb__status__codes__pb2._STATUSIDS_STATUSCODE
_EXECUTESCANQUERYPARTIALRESPONSE.fields_by_name['issues'].message_type = protos_dot_ydb__issue__message__pb2._ISSUEMESSAGE
_EXECUTESCANQUERYPARTIALRESPONSE.fields_by_name['result'].message_type = _EXECUTESCANQUERYPARTIALRESULT
_EXECUTESCANQUERYPARTIALRESULT.fields_by_name['result_set'].message_type = protos_dot_ydb__value__pb2._RESULTSET
_EXECUTESCANQUERYPARTIALRESULT.fields_by_name['query_stats'].message_type = protos_dot_ydb__query__stats__pb2._QUERYSTATS
_EXECUTESCANQUERYPARTIALRESULT.fields_by_name['snapshot'].message_type = protos_dot_ydb__common__pb2._VIRTUALTIMESTAMP
_DESCRIBEEXTERNALDATASOURCEREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_DESCRIBEEXTERNALDATASOURCERESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_DESCRIBEEXTERNALDATASOURCERESULT_PROPERTIESENTRY.containing_type = _DESCRIBEEXTERNALDATASOURCERESULT
_DESCRIBEEXTERNALDATASOURCERESULT.fields_by_name['self'].message_type = protos_dot_ydb__scheme__pb2._ENTRY
_DESCRIBEEXTERNALDATASOURCERESULT.fields_by_name['properties'].message_type = _DESCRIBEEXTERNALDATASOURCERESULT_PROPERTIESENTRY
_DESCRIBEEXTERNALDATASOURCERESULT.oneofs_by_name['_source_type'].fields.append(
  _DESCRIBEEXTERNALDATASOURCERESULT.fields_by_name['source_type'])
_DESCRIBEEXTERNALDATASOURCERESULT.fields_by_name['source_type'].containing_oneof = _DESCRIBEEXTERNALDATASOURCERESULT.oneofs_by_name['_source_type']
_DESCRIBEEXTERNALDATASOURCERESULT.oneofs_by_name['_location'].fields.append(
  _DESCRIBEEXTERNALDATASOURCERESULT.fields_by_name['location'])
_DESCRIBEEXTERNALDATASOURCERESULT.fields_by_name['location'].containing_oneof = _DESCRIBEEXTERNALDATASOURCERESULT.oneofs_by_name['_location']
_DESCRIBEEXTERNALTABLEREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_DESCRIBEEXTERNALTABLERESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_DESCRIBEEXTERNALTABLERESULT_CONTENTENTRY.containing_type = _DESCRIBEEXTERNALTABLERESULT
_DESCRIBEEXTERNALTABLERESULT.fields_by_name['self'].message_type = protos_dot_ydb__scheme__pb2._ENTRY
_DESCRIBEEXTERNALTABLERESULT.fields_by_name['columns'].message_type = _COLUMNMETA
_DESCRIBEEXTERNALTABLERESULT.fields_by_name['content'].message_type = _DESCRIBEEXTERNALTABLERESULT_CONTENTENTRY
_DESCRIBEEXTERNALTABLERESULT.oneofs_by_name['_source_type'].fields.append(
  _DESCRIBEEXTERNALTABLERESULT.fields_by_name['source_type'])
_DESCRIBEEXTERNALTABLERESULT.fields_by_name['source_type'].containing_oneof = _DESCRIBEEXTERNALTABLERESULT.oneofs_by_name['_source_type']
_DESCRIBEEXTERNALTABLERESULT.oneofs_by_name['_data_source_path'].fields.append(
  _DESCRIBEEXTERNALTABLERESULT.fields_by_name['data_source_path'])
_DESCRIBEEXTERNALTABLERESULT.fields_by_name['data_source_path'].containing_oneof = _DESCRIBEEXTERNALTABLERESULT.oneofs_by_name['_data_source_path']
_DESCRIBEEXTERNALTABLERESULT.oneofs_by_name['_location'].fields.append(
  _DESCRIBEEXTERNALTABLERESULT.fields_by_name['location'])
_DESCRIBEEXTERNALTABLERESULT.fields_by_name['location'].containing_oneof = _DESCRIBEEXTERNALTABLERESULT.oneofs_by_name['_location']
_DESCRIBESYSTEMVIEWREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_DESCRIBESYSTEMVIEWRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_DESCRIBESYSTEMVIEWRESULT_ATTRIBUTESENTRY.containing_type = _DESCRIBESYSTEMVIEWRESULT
_DESCRIBESYSTEMVIEWRESULT.fields_by_name['self'].message_type = protos_dot_ydb__scheme__pb2._ENTRY
_DESCRIBESYSTEMVIEWRESULT.fields_by_name['columns'].message_type = _COLUMNMETA
_DESCRIBESYSTEMVIEWRESULT.fields_by_name['attributes'].message_type = _DESCRIBESYSTEMVIEWRESULT_ATTRIBUTESENTRY
...
DESCRIPTOR.message_types_by_name['GlobalUniqueIndex'] = _GLOBALUNIQUEINDEX
...
DESCRIPTOR.message_types_by_name['ChangefeedMode'] = _CHANGEFEEDMODE
DESCRIPTOR.message_types_by_name['ChangefeedFormat'] = _CHANGEFEEDFORMAT
DESCRIPTOR.message_types_by_name['Changefeed'] = _CHANGEFEED
DESCRIPTOR.message_types_by_name['ChangefeedDescription'] = _CHANGEFEEDDESCRIPTION
...
DESCRIPTOR.message_types_by_name['SequenceDescription'] = _SEQUENCEDESCRIPTION
...
DESCRIPTOR.message_types_by_name['RenameIndexItem'] = _RENAMEINDEXITEM
...
DESCRIPTOR.message_types_by_name['SnapshotRWModeSettings'] = _SNAPSHOTRWMODESETTINGS
DESCRIPTOR.message_types_by_name['ReadCommittedRWModeSettings'] = _READCOMMITTEDRWMODESETTINGS
DESCRIPTOR.message_types_by_name['StrictSerializableRWModeSettings'] = _STRICTSERIALIZABLERWMODESETTINGS
...
DESCRIPTOR.message_types_by_name['DescribeExternalDataSourceRequest'] = _DESCRIBEEXTERNALDATASOURCEREQUEST
DESCRIPTOR.message_types_by_name['DescribeExternalDataSourceResponse'] = _DESCRIBEEXTERNALDATASOURCERESPONSE
DESCRIPTOR.message_types_by_name['DescribeExternalDataSourceResult'] = _DESCRIBEEXTERNALDATASOURCERESULT
DESCRIPTOR.message_types_by_name['DescribeExternalTableRequest'] = _DESCRIBEEXTERNALTABLEREQUEST
DESCRIPTOR.message_types_by_name['DescribeExternalTableResponse'] = _DESCRIBEEXTERNALTABLERESPONSE
DESCRIPTOR.message_types_by_name['DescribeExternalTableResult'] = _DESCRIBEEXTERNALTABLERESULT
DESCRIPTOR.message_types_by_name['DescribeSystemViewRequest'] = _DESCRIBESYSTEMVIEWREQUEST
DESCRIPTOR.message_types_by_name['DescribeSystemViewResponse'] = _DESCRIBESYSTEMVIEWRESPONSE
DESCRIPTOR.message_types_by_name['DescribeSystemViewResult'] = _DESCRIBESYSTEMVIEWRESULT
...
CreateSessionRequest = _reflection.GeneratedProtocolMessageType('CreateSessionRequest', (_message.Message,), {
  ...
  '__module__' : 'protos.ydb_table_pb2'
...
GlobalUniqueIndex = _reflection.GeneratedProtocolMessageType('GlobalUniqueIndex', (_message.Message,), {
  'DESCRIPTOR' : _GLOBALUNIQUEINDEX,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.GlobalUniqueIndex)
  })
_sym_db.RegisterMessage(GlobalUniqueIndex)
...
ChangefeedMode = _reflection.GeneratedProtocolMessageType('ChangefeedMode', (_message.Message,), {
  'DESCRIPTOR' : _CHANGEFEEDMODE,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.ChangefeedMode)
  })
_sym_db.RegisterMessage(ChangefeedMode)

ChangefeedFormat = _reflection.GeneratedProtocolMessageType('ChangefeedFormat', (_message.Message,), {
  'DESCRIPTOR' : _CHANGEFEEDFORMAT,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.ChangefeedFormat)
  })
_sym_db.RegisterMessage(ChangefeedFormat)

Changefeed = _reflection.GeneratedProtocolMessageType('Changefeed', (_message.Message,), {

  'AttributesEntry' : _reflection.GeneratedProtocolMessageType('AttributesEntry', (_message.Message,), {
    'DESCRIPTOR' : _CHANGEFEED_ATTRIBUTESENTRY,
    '__module__' : 'protos.ydb_table_pb2'
    # @@protoc_insertion_point(class_scope:Ydb.Table.Changefeed.AttributesEntry)
    })
  ,
...
_sym_db.RegisterMessage(Changefeed.AttributesEntry)

ChangefeedDescription = _reflection.GeneratedProtocolMessageType('ChangefeedDescription', (_message.Message,), {

  'InitialScanProgress' : _reflection.GeneratedProtocolMessageType('InitialScanProgress', (_message.Message,), {
    'DESCRIPTOR' : _CHANGEFEEDDESCRIPTION_INITIALSCANPROGRESS,
    '__module__' : 'protos.ydb_table_pb2'
    # @@protoc_insertion_point(class_scope:Ydb.Table.ChangefeedDescription.InitialScanProgress)
    })
  ,

  'AttributesEntry' : _reflection.GeneratedProtocolMessageType('AttributesEntry', (_message.Message,), {
    'DESCRIPTOR' : _CHANGEFEEDDESCRIPTION_ATTRIBUTESENTRY,
    '__module__' : 'protos.ydb_table_pb2'
    # @@protoc_insertion_point(class_scope:Ydb.Table.ChangefeedDescription.AttributesEntry)
    })
  ,
  'DESCRIPTOR' : _CHANGEFEEDDESCRIPTION,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.ChangefeedDescription)
  })
_sym_db.RegisterMessage(ChangefeedDescription)
_sym_db.RegisterMessage(ChangefeedDescription.InitialScanProgress)
_sym_db.RegisterMessage(ChangefeedDescription.AttributesEntry)
...
SequenceDescription = _reflection.GeneratedProtocolMessageType('SequenceDescription', (_message.Message,), {

  'SetVal' : _reflection.GeneratedProtocolMessageType('SetVal', (_message.Message,), {
    'DESCRIPTOR' : _SEQUENCEDESCRIPTION_SETVAL,
    '__module__' : 'protos.ydb_table_pb2'
    # @@protoc_insertion_point(class_scope:Ydb.Table.SequenceDescription.SetVal)
    })
  ,
  'DESCRIPTOR' : _SEQUENCEDESCRIPTION,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.SequenceDescription)
  })
_sym_db.RegisterMessage(SequenceDescription)
_sym_db.RegisterMessage(SequenceDescription.SetVal)
...
RenameIndexItem = _reflection.GeneratedProtocolMessageType('RenameIndexItem', (_message.Message,), {
  'DESCRIPTOR' : _RENAMEINDEXITEM,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.RenameIndexItem)
  })
_sym_db.RegisterMessage(RenameIndexItem)
...
SnapshotModeSettings = _reflection.GeneratedProtocolMessageType('SnapshotModeSettings', (_message.Message,), {
  ...
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.SnapshotModeSettings)
  })
_sym_db.RegisterMessage(SnapshotModeSettings)

SnapshotRWModeSettings = _reflection.GeneratedProtocolMessageType('SnapshotRWModeSettings', (_message.Message,), {
  'DESCRIPTOR' : _SNAPSHOTRWMODESETTINGS,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.SnapshotRWModeSettings)
  })
_sym_db.RegisterMessage(SnapshotRWModeSettings)

ReadCommittedRWModeSettings = _reflection.GeneratedProtocolMessageType('ReadCommittedRWModeSettings', (_message.Message,), {
  'DESCRIPTOR' : _READCOMMITTEDRWMODESETTINGS,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.ReadCommittedRWModeSettings)
  })
_sym_db.RegisterMessage(ReadCommittedRWModeSettings)

StrictSerializableRWModeSettings = _reflection.GeneratedProtocolMessageType('StrictSerializableRWModeSettings', (_message.Message,), {
  'DESCRIPTOR' : _STRICTSERIALIZABLERWMODESETTINGS,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.StrictSerializableRWModeSettings)
  })
_sym_db.RegisterMessage(StrictSerializableRWModeSettings)
...
ReadRowsRequest = _reflection.GeneratedProtocolMessageType('ReadRowsRequest', (_message.Message,), {
  ...
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.ReadRowsRequest)
  })
...
ReadRowsResponse = _reflection.GeneratedProtocolMessageType('ReadRowsResponse', (_message.Message,), {
  ...
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.ReadRowsResponse)
  })
...
DescribeExternalDataSourceRequest = _reflection.GeneratedProtocolMessageType('DescribeExternalDataSourceRequest', (_message.Message,), {
  'DESCRIPTOR' : _DESCRIBEEXTERNALDATASOURCEREQUEST,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeExternalDataSourceRequest)
  })
_sym_db.RegisterMessage(DescribeExternalDataSourceRequest)

DescribeExternalDataSourceResponse = _reflection.GeneratedProtocolMessageType('DescribeExternalDataSourceResponse', (_message.Message,), {
  'DESCRIPTOR' : _DESCRIBEEXTERNALDATASOURCERESPONSE,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeExternalDataSourceResponse)
  })
_sym_db.RegisterMessage(DescribeExternalDataSourceResponse)

DescribeExternalDataSourceResult = _reflection.GeneratedProtocolMessageType('DescribeExternalDataSourceResult', (_message.Message,), {

  'PropertiesEntry' : _reflection.GeneratedProtocolMessageType('PropertiesEntry', (_message.Message,), {
    'DESCRIPTOR' : _DESCRIBEEXTERNALDATASOURCERESULT_PROPERTIESENTRY,
    '__module__' : 'protos.ydb_table_pb2'
    # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeExternalDataSourceResult.PropertiesEntry)
    })
  ,
  'DESCRIPTOR' : _DESCRIBEEXTERNALDATASOURCERESULT,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeExternalDataSourceResult)
  })
_sym_db.RegisterMessage(DescribeExternalDataSourceResult)
_sym_db.RegisterMessage(DescribeExternalDataSourceResult.PropertiesEntry)

DescribeExternalTableRequest = _reflection.GeneratedProtocolMessageType('DescribeExternalTableRequest', (_message.Message,), {
  'DESCRIPTOR' : _DESCRIBEEXTERNALTABLEREQUEST,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeExternalTableRequest)
  })
_sym_db.RegisterMessage(DescribeExternalTableRequest)

DescribeExternalTableResponse = _reflection.GeneratedProtocolMessageType('DescribeExternalTableResponse', (_message.Message,), {
  'DESCRIPTOR' : _DESCRIBEEXTERNALTABLERESPONSE,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeExternalTableResponse)
  })
_sym_db.RegisterMessage(DescribeExternalTableResponse)

DescribeExternalTableResult = _reflection.GeneratedProtocolMessageType('DescribeExternalTableResult', (_message.Message,), {

  'ContentEntry' : _reflection.GeneratedProtocolMessageType('ContentEntry', (_message.Message,), {
    'DESCRIPTOR' : _DESCRIBEEXTERNALTABLERESULT_CONTENTENTRY,
    '__module__' : 'protos.ydb_table_pb2'
    # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeExternalTableResult.ContentEntry)
    })
  ,
  'DESCRIPTOR' : _DESCRIBEEXTERNALTABLERESULT,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeExternalTableResult)
  })
_sym_db.RegisterMessage(DescribeExternalTableResult)
_sym_db.RegisterMessage(DescribeExternalTableResult.ContentEntry)

DescribeSystemViewRequest = _reflection.GeneratedProtocolMessageType('DescribeSystemViewRequest', (_message.Message,), {
  'DESCRIPTOR' : _DESCRIBESYSTEMVIEWREQUEST,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeSystemViewRequest)
  })
_sym_db.RegisterMessage(DescribeSystemViewRequest)

DescribeSystemViewResponse = _reflection.GeneratedProtocolMessageType('DescribeSystemViewResponse', (_message.Message,), {
  'DESCRIPTOR' : _DESCRIBESYSTEMVIEWRESPONSE,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeSystemViewResponse)
  })
_sym_db.RegisterMessage(DescribeSystemViewResponse)

DescribeSystemViewResult = _reflection.GeneratedProtocolMessageType('DescribeSystemViewResult', (_message.Message,), {

  'AttributesEntry' : _reflection.GeneratedProtocolMessageType('AttributesEntry', (_message.Message,), {
    'DESCRIPTOR' : _DESCRIBESYSTEMVIEWRESULT_ATTRIBUTESENTRY,
    '__module__' : 'protos.ydb_table_pb2'
    # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeSystemViewResult.AttributesEntry)
    })
  ,
  'DESCRIPTOR' : _DESCRIBESYSTEMVIEWRESULT,
  '__module__' : 'protos.ydb_table_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Table.DescribeSystemViewResult)
  })
_sym_db.RegisterMessage(DescribeSystemViewResult)
_sym_db.RegisterMessage(DescribeSystemViewResult.AttributesEntry)
...
_EXECUTEDATAQUERYREQUEST.fields_by_name['parameters']._options = None
...
_EXECUTESCANQUERYREQUEST.fields_by_name['parameters']._options = None
