...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/ydb_monitoring.proto',
...
_NODECHECKREQUEST = _descriptor.Descriptor(
  name='NodeCheckRequest',
  full_name='Ydb.Monitoring.NodeCheckRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='operation_params', full_name='Ydb.Monitoring.NodeCheckRequest.operation_params', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NODECHECKRESPONSE = _descriptor.Descriptor(
  name='NodeCheckResponse',
  full_name='Ydb.Monitoring.NodeCheckResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='operation', full_name='Ydb.Monitoring.NodeCheckResponse.operation', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOCATIONNODE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pile', full_name='Ydb.Monitoring.LocationNode.pile', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOCATIONSTORAGEGROUP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pile', full_name='Ydb.Monitoring.LocationStorageGroup.pile', index=2,
...
_LOCATIONBRIDGEPILE = _descriptor.Descriptor(
  name='LocationBridgePile',
  full_name='Ydb.Monitoring.LocationBridgePile',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Ydb.Monitoring.LocationBridgePile.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOCATIONCOMPUTE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pile', full_name='Ydb.Monitoring.LocationCompute.pile', index=3,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ISSUELOG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='listed', full_name='Ydb.Monitoring.IssueLog.listed', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='count', full_name='Ydb.Monitoring.IssueLog.count', index=8,
...
_SELFCHECKREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_SELFCHECKREQUEST.fields_by_name['minimum_status'].enum_type = _STATUSFLAG_STATUS
_SELFCHECKRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
_NODECHECKREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
_NODECHECKRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
...
_LOCATIONNODE.fields_by_name['pile'].message_type = _LOCATIONBRIDGEPILE
...
_LOCATIONSTORAGEGROUP.fields_by_name['pile'].message_type = _LOCATIONBRIDGEPILE
...
_LOCATIONCOMPUTE.fields_by_name['pile'].message_type = _LOCATIONBRIDGEPILE
...
DESCRIPTOR.message_types_by_name['NodeCheckRequest'] = _NODECHECKREQUEST
DESCRIPTOR.message_types_by_name['NodeCheckResponse'] = _NODECHECKRESPONSE
...
DESCRIPTOR.message_types_by_name['LocationBridgePile'] = _LOCATIONBRIDGEPILE
...
StatusFlag = _reflection.GeneratedProtocolMessageType('StatusFlag', (_message.Message,), {
  ...
  '__module__' : 'protos.ydb_monitoring_pb2'
...
NodeCheckRequest = _reflection.GeneratedProtocolMessageType('NodeCheckRequest', (_message.Message,), {
  'DESCRIPTOR' : _NODECHECKREQUEST,
  '__module__' : 'protos.ydb_monitoring_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Monitoring.NodeCheckRequest)
  })
_sym_db.RegisterMessage(NodeCheckRequest)

NodeCheckResponse = _reflection.GeneratedProtocolMessageType('NodeCheckResponse', (_message.Message,), {
  'DESCRIPTOR' : _NODECHECKRESPONSE,
  '__module__' : 'protos.ydb_monitoring_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Monitoring.NodeCheckResponse)
  })
_sym_db.RegisterMessage(NodeCheckResponse)
...
LocationBridgePile = _reflection.GeneratedProtocolMessageType('LocationBridgePile', (_message.Message,), {
  'DESCRIPTOR' : _LOCATIONBRIDGEPILE,
  '__module__' : 'protos.ydb_monitoring_pb2'
  # @@protoc_insertion_point(class_scope:Ydb.Monitoring.LocationBridgePile)
  })
_sym_db.RegisterMessage(LocationBridgePile)
