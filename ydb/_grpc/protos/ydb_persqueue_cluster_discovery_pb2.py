...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/ydb_persqueue_cluster_discovery.proto',
  ...
  ,
  dependencies=[google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,protos_dot_ydb__operation__pb2.DESCRIPTOR,])
...
_DISCOVERCLUSTERSREQUEST.fields_by_name['operation_params'].message_type = protos_dot_ydb__operation__pb2._OPERATIONPARAMS
...
_DISCOVERCLUSTERSRESPONSE.fields_by_name['operation'].message_type = protos_dot_ydb__operation__pb2._OPERATION
...
WriteSessionParams = _reflection.GeneratedProtocolMessageType('WriteSessionParams', (_message.Message,), {
  ...
  '__module__' : 'protos.ydb_persqueue_cluster_discovery_pb2'
