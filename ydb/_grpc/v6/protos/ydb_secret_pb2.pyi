...
class DescribeSecretRequest(_message.Message):
...
class DescribeSecretResponse(_message.Message):
    __slots__ = ("operation",)
...
class DescribeSecretResult(_message.Message):
    __slots__ = ("self", "version")
    SELF_FIELD_NUMBER: _ClassVar[int]
    VERSION_FIELD_NUMBER: _ClassVar[int]
    self: _ydb_scheme_pb2.Entry
    version: int
    def __init__(self_, self: _Optional[_Union[_ydb_scheme_pb2.Entry, _Mapping]] = ..., version: _Optional[int] = ...) -> None: ...
