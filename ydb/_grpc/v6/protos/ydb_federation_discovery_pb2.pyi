...
class DatabaseInfo(_message.Message):
    __slots__ = ("name", "path", "id", "endpoint", "location", "status", "weight")
    class Status(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STATUS_UNSPECIFIED: _ClassVar[DatabaseInfo.Status]
        AVAILABLE: _ClassVar[DatabaseInfo.Status]
        READ_ONLY: _ClassVar[DatabaseInfo.Status]
        UNAVAILABLE: _ClassVar[DatabaseInfo.Status]
