...
class ISession:
    ...
    @abstractmethod
    def transaction(self, tx_mode=None, allow_split_transactions=_allow_split_transaction):
        pass
...
class BaseTxContext(ITxContext):
    ...
    def __init__(
        self, driver, session_state, session, tx_mode=None, *, allow_split_transactions=_allow_split_transaction
    ):
        """
        An object that provides a simple transaction context manager that allows statements execution
        in a transaction. You don't have to open transaction explicitly, because context manager encapsulates
