...
# source: grpc/ydb_scheme_v1.proto
...
_SCHEMESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=protos_dot_ydb__scheme__pb2._MAKEDIRECTORYREQUEST,
    output_type=protos_dot_ydb__scheme__pb2._MAKEDIRECTORYRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    index=1,
    containing_service=None,
    input_type=protos_dot_ydb__scheme__pb2._REMOVEDIRECTORYREQUEST,
    output_type=protos_dot_ydb__scheme__pb2._REMOVEDIRECTORYRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    index=2,
    containing_service=None,
    input_type=protos_dot_ydb__scheme__pb2._LISTDIRECTORYREQUEST,
    output_type=protos_dot_ydb__scheme__pb2._LISTDIRECTORYRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    index=3,
    containing_service=None,
    input_type=protos_dot_ydb__scheme__pb2._DESCRIBEPATHREQUEST,
    output_type=protos_dot_ydb__scheme__pb2._DESCRIBEPATHRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    index=4,
    containing_service=None,
    input_type=protos_dot_ydb__scheme__pb2._MODIFYPERMISSIONSREQUEST,
    output_type=protos_dot_ydb__scheme__pb2._MODIFYPERMISSIONSRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
